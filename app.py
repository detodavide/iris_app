...
def main():
    ...
    if file is None:
        ...
        input1 = st.number_input("Enter a value for sepal length", value=0.00)
        input2 = st.number_input("Enter a float value for sepal width", value=0.00)
        input3 = st.number_input("Enter a float value for petal length", value=0.00)
        input4 = st.number_input("Enter a float value for petal width", value=0.00)
